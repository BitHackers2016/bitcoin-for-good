...
Charity.create({ein: '123457', name: 'Charity B', city: 'B City',
                  state: 'StateB', email: 'charityb@boots.org', country: 'USA'})
Charity.create({ein: '123458', name: 'Charity C', city: 'C City',
                  state: 'StateC', email: 'charityC@boots.org', country: 'USA'})
Charity.create({ein: '123459', name: 'Charity D', city: 'D City',
                  state: 'StateD', email: 'charityd@boots.org', country: 'USA'})
Charity.create({ein: '123460', name: 'Charity E', city: 'E City',
